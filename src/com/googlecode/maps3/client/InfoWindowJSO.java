 ...
 */
public class InfoWindowJSO extends JavaScriptObject
{
	/** Required for overlays */
	protected InfoWindowJSO() {}
	
	/**
	 */
	public static native InfoWindowJSO newInstance() /*-{
		return new $wnd.google.maps.InfoWindow();
	}-*/;

	/**
	 */
	public static native InfoWindowJSO newInstance(InfoWindowOptions opts) /*-{
