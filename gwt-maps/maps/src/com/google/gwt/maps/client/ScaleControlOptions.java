 ...
 * {@code <a href="http://code.google.com/apis/maps/documentation/v3/reference.html#ScaleControlOptions">JavaScript reference page.</a>}
 */
public class ScaleControlOptions extends JavaScriptObject {

  /**
   * Instantiates a ScaleControlOptions object.
   * 
   * @return An instance of ScaleControlOptions.
   * 
  ...
  public static native ScaleControlOptions newInstance() /*-{
    return new $wnd.ScaleControlOptions();
  }-*/;
   ...
   */
  public final native void setStyle(ScaleControlStyle style) /*-{
    this.style = style;
  }-*/;
